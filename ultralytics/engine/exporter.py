...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        # Filter warnings
        warnings.filterwarnings("ignore", category=torch.jit.scriptrWarning)  # suppress TracerWarning
    ...
    def export_torchscript(self, prefix=colorstr("TorchScript:")):
        ...
        ts = torch.jit.script(self.model, self.im, strict=False)
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        ...
        ts = torch.jit.script(model.eval(), self.im, strict=False)  # TorchScript model
        ct_model = ct.convert(
            ts,
